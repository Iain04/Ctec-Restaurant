function fetchReviews() {
    ...
    request.open('GET', "http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/review", true);
...
function addReview() {
    if (sessionStorage.getItem("username") != null) {
        ...
        request.open("POST", "http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/review", true); 
...
function updateReview() {
    if (sessionStorage.getItem("username") != null) {
        ...
        if (response == true) {
            var edit_review_url = "http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/review" + "/" + review_array[currentIndex]._id;
            var request = new XMLHttpRequest();
...
function deleteReview(element) {
    if (sessionStorage.getItem("username") != null) {
        ...
        if (response == true) {
            var item = element.getAttribute("item");
            var delete_review_url = "http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/review" + "/" + review_array[item]._id;
            var request = new XMLHttpRequest();
