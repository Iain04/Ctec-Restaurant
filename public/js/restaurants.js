function getFeaturedData() {
    ...
    request.open('GET', 'http://ec2-54-166-17-19.compute-1.amazonaws.com/featured', true);
...
function getRestaurantData() {
    var request = new XMLHttpRequest();
    request.open('GET', 'http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/restaurant', true);
    request.onload = function () {    
        restaurant_array = JSON.parse(request.responseText);
        console.log(restaurant_array)             	
        displayRestaurants();
...
function searchRestaurant(searchtxt) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/search', true);
...
function getRestaurantCategory(categorytxt) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'http://ec2-54-166-17-19.compute-1.amazonaws.com:8080/category', true);
    request.setRequestHeader("Content-Type", "application/json");
    request.onload = function () {
        restaurant_array = JSON.parse(request.responseText);
        console.log(restaurant_array);
