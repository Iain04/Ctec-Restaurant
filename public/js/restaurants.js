function getFeaturedData() {
    ...
    request.open('GET', 'http://127.0.0.1:8080/featured', true);
...
function getRestaurantData() {
    var request = new XMLHttpRequest();
    request.open('GET', 'http://127.0.0.1:8080/restaurant', true);
    request.onload = function () {    
        restaurant_array = JSON.parse(request.responseText);
        console.log(restaurant_array)             	
        displayRestaurants();
...
function searchRestaurant(searchtxt) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'http://127.0.0.1:8080/search', true);
...
function getRestaurantCategory(categorytxt) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'http://127.0.0.1:8080/category', true);
    request.setRequestHeader("Content-Type", "application/json");
    request.onload = function () {
        restaurant_array = JSON.parse(request.responseText);
        console.log(restaurant_array);
